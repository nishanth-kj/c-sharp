...
public class ActivityRepository(PulseDbContext db) : IActivityRepository
{
...
public class GoalRepository(PulseDbContext db) : IGoalRepository
{
...
public class DailySnapshotRepository(PulseDbContext db) : IDailySnapshotRepository
{
...
public class CategoryRepository(PulseDbContext db) : ICategoryRepository
{
