...
This Code of Conduct applies within all project spaces, including the repository, issues, pull requests, discussions, and any other communication channels associated with the project. It also applies when an individual is representing the project in public spaces.
